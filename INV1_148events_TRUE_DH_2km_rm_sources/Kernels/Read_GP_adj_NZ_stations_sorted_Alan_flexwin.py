...
R_all_arr=np.loadtxt('../../../../Kernels/index_all_ncc_pyflex_gt05.txt')
#R_all_arr=np.loadtxt('../../../../Kernels/index_all_ncc_pyflex_gaussian_Tshift.txt')
...
#            stat_data_0_O = rms(stat_data_0_O)*wr_ij
            ...
            source_adj=source_adj_1(stat_data_0_S,stat_data_0_O,num_pts,dt,wd) 
