...
for it in range(1,iters+1):
    ...
    for ipart in range(1,3):
        ...
        os.system('cp %s' %'Master_iterations_part_i_pyflex.py ../../../PART'+str(ipart)+'/Kernels/Iters/iter1/')
...
#    job_submittted(job_file3)
    ...
    os.system('python Sum_Gradients_nShot_vsp_tape_xyz_pyflex.py')
    time.sleep(10)
...
#    opt_step_L2,flag = Step_length_srf_checked.Step_length(Err,S,nShot,sNames,it)
    opt_step_L2,flag = Step_length_srf_pyflex.Step_length(Err,S,nShot,sNames,it)
