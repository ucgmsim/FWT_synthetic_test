...
#        stat_data_2_O = signal.filtfilt(b, a, stat_data_2_O)           
        ...
        source_x=source_adj_1(stat_data_0_S,stat_data_0_O,num_pts,dt,window_pad0)
        source_y=source_adj_1(stat_data_1_S,stat_data_1_O,num_pts,dt,window_pad1)    
        source_z=source_adj_1(stat_data_2_S,stat_data_2_O,num_pts,dt,window_pad2)   
    else:
