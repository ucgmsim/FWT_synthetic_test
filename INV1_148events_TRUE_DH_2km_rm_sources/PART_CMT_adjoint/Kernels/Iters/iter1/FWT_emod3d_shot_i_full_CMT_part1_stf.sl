...
set VERSION = 3.0.8
set EMOD_DIR = /scale_wlg_persistent/filesets/home/rgraves/Mpi/Emod3d/V${VERSION}
...
srun $EMOD_DIR/emod3d-mpi par=FWD/e3d_mysource_i_full_CMT.par < /dev/null
echo "FW emod3d"

python -c "from qcore import timeseries as ts; ts.LFSeis('OutBin').all2txt(prefix='$Vel_es_i/')"
