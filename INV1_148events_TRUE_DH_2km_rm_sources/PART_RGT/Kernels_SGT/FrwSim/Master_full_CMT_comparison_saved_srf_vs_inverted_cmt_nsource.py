...
#    job_submittted(job_file)    
    os.system('python nsource_sgt2cmt_misfit.py')
...
#    job_file = 'adj_cmt.sl'
#    job_submittted(job_file)
    os.system('python nsource_cmt_misfit.py')
    print("cmt misfit") 

#f_err=open('srf_err.dat','r'); Err1=np.fromfile(f_err,dtype=np.float64); print('Err1='+str(Err1))    
