...
set EQLOC_FILE = eqloc_2km.txt
set ELON = ( 172.83 	172.84 	 172.77 )
set ELAT = ( -43.46 	-43.49   -43.53 )
set EDEP = (   4.00    	6.00   	 6.00 )
...
set RADIUS_FILE = sgt.radiusfile_2km
...
set ZLEV = (  5.0 10.0 15.0 )
set ZINC = (    1   2   5 )

set RLEV = ( 10.0 20.0 30.0 )
set RINC = (   1   2    3  )
...
set SXY = `echo $SLON[$s] $SLAT[$s] | /scale_wlg_persistent/filesets/home/rgraves/Bin/ll2xy mlon=$MODEL_LON mlat=$MODEL_LAT xazim=$XAZIM`
echo $SXY
...
/scale_wlg_persistent/filesets/home/rgraves/Bin/gen_sgtgrid nx=$NX ny=$NY nz=$NZ h=$HH xsrc=$XSRC ysrc=$YSRC \
