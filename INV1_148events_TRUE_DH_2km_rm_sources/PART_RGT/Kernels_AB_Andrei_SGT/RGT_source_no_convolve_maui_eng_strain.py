...
#                    AA[ishot_id,i,k,:,3]=conv_source(eii3_fw,source,nt0,dt0)
                    AA[ishot_id,i,k,:,1]=2*eii3_fw
                    AA[ishot_id,i,k,:,3]=2*eii3_fw
                if(int(ij_array[ij])==2):
                    AA[ishot_id,i,k,:,2]=2*eii3_fw
                    AA[ishot_id,i,k,:,6]=2*eii3_fw     
                if(int(ij_array[ij])==5):
                    AA[ishot_id,i,k,:,5]=2*eii3_fw
                    AA[ishot_id,i,k,:,7]=2*eii3_fw                      
                    
np.savetxt('AA_8events.txt',AA.reshape(-1))
input('-->')
##############################################
