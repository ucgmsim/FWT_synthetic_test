...
#print(np.max(AA.reshape(-1)))                  
#np.savetxt('AA_8events_Gaussian_test_1station.txt',AA.reshape(-1))
np.savetxt('AA_8events_Gaussian_test_1station.txt',AA.reshape(-1))
#np.savetxt('AA_8events_Gaussian_test_2000.txt',AA.reshape(-1))
input('finish AA calculation -->')
##############################################
