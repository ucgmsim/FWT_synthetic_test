...
#for ishot in range(95,104+1):
    ...
    #            stat_data_2_O = signal.filtfilt(b, a, stat_data_2_O)       
                ...
                wd=np.exp(-(0.5*sd**2)*(t-t[I_max])**2)

                Err=Err+ rwm_wd(stat_data_0_S,stat_data_0_O,num_pts, dt,wd)+rwm_wd(stat_data_1_S,stat_data_1_O,num_pts, dt,wd)+rwm_wd(stat_data_2_S,stat_data_2_O,num_pts, dt,wd)
